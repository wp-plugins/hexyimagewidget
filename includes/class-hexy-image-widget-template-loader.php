 ...
 * @author  Gary Jones
 */
class Hexy_Image_Widget_Template_Loader {
	/**
	 ...
	 * @type string
	 */
	protected $filter_prefix = 'hexy_image_widget';
	 ...
	 * @type string
	 */
	protected $theme_template_directory = 'hexy-image-widget';
	 ...
	 * @since 4.0.0
	 *
	 * @uses Hexy_Image_Widget_Template_Loader::get_template_possble_parts()
	 *     Create file names of templates.
	 * @uses Hexy_Image_Widget_Template_Loader::locate_template() Retrieve the
	 ...
	 * @since 4.0.0
	 *
	 * @uses Hexy_Image_Widget_Template_Loader::get_template_paths() Return a
